...
class FrezyPalchikovyeItem
{
private $domain ;                     // Домен поставщика
private $name ;                       // Наименование
private $diameter ;                   // Диаметр, мм
private $shank ;                      // Крепление
private $cutter_height ;              // Высота фрезы, мм
private $segments_height ;            // Высота рабочей части, мм
...
private $date_add ;
    ...
    /**
     * FrezyPalchikovyeItem constructor.
     * @param $domain
     * @param $name
     * @param $shank
     * @param $material
     ...
     * @param $date_add
     */
    public function __construct($domain, $name, $shank, $material, $price, $url, $date_add)
    {
        $this->domain = $domain;
        $this->name = $name;
        $this->shank = $shank;
